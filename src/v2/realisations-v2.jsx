...
// Page Réalisations de la V2 : reprise de la page Réalisations de la V1 (mêmes contenus),
// passée au branding V2 — bleu Kairn, hero sombre animé, navigation, pied de page et réservation V2.
...
function RealisationsHero() {
  ...
  return (
    <section className="hero is-dark real-hero">
      <div className="glow-bg" aria-hidden="true" />
      <LivingGradient />
      <div className="wrap hero-inner">
        <motion.span className="pill" initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: EASE }}>
          <span className="pill-dot"><i /></span>Réalisations 2026
        </motion.span>
        <motion.h1 initial={{ opacity: 0, y: 30, filter: 'blur(8px)' }} animate={{ opacity: 1, y: 0, filter: 'blur(0px)' }} transition={{ duration: 0.9, ease: EASE, delay: 0.1 }}>
          Ce qu’on a livré. <span className="serif grad-text">Ce que ça a donné.</span>
        </motion.h1>
        <motion.p className="hero-lead" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: EASE, delay: 0.35 }}>
          Campagnes, landing pages, CRM sur mesure et automatisations, livrés sous un seul toit. Avec des résultats traçables, pas des slides.
        </motion.p>
        <motion.div className="hero-actions" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: EASE, delay: 0.5 }}>
          <BookCta>Réserver 30 min</BookCta>
        </motion.div>
      </div>
    </section>
  );
...
function TunnelLayer({ step, label, title, body, url, img, alt, objectPosition = 'top', objectFit = 'cover', isMobile, isLast = false }) {
  return (
    <div style={{
      ...
      borderBottom: isLast ? 'none' : '1px dashed rgba(169,193,255,.18)',
    }}>
      <div>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 12, marginBottom: 14 }}>
          <span className="mono" style={{
            ...
            background: 'linear-gradient(180deg, #A9C1FF, #3B82F6)',
    ...
    <section style={{ padding: pad, background: 'var(--bg)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{
          ...
          overflow: 'hidden',
          background: 'linear-gradient(180deg, #0E0820 0%, #150B2E 50%, #0B0918 100%)',
          border: '1px solid rgba(59,130,246,.25)',
          boxShadow: '0 40px 120px -30px rgba(47,91,234,.55)',
        }}>
          {/* ambient glow */}
          <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 85% -10%, rgba(59,130,246,.4), transparent 55%), radial-gradient(ellipse at 15% 120%, rgba(169,193,255,.18), transparent 55%)', pointerEvents: 'none' }}></div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <span style={{
                ...
                border: '1px solid rgba(169,193,255,.3)',
                fontFamily: 'Geist Mono, monospace',
                fontSize: 11, fontWeight: 500, color: '#A9C1FF',
                letterSpacing: '0.14em', textTransform: 'uppercase',
              }}>
                <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#A9C1FF', boxShadow: '0 0 8px rgba(169,193,255,.7)' }}></span>
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(255,255,255,.12)'; e.currentTarget.style.borderColor = 'rgba(169,193,255,.4)'; }}
            ...
            >
              <span className="mono" style={{ fontSize: 12, color: 'rgba(169,193,255,.8)', letterSpacing: '0.14em', textTransform: 'uppercase' }}>Live</span>
              tradeauto.ch
          ...
          <div style={{ position: 'relative', padding: isMobile ? '32px 20px 20px' : '56px 48px 32px', display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr auto', gap: isMobile ? 20 : 40, alignItems: 'flex-end' }}>
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
                ...
                <div>
                  <div className="mono" style={{ fontSize: 11, color: 'rgba(169,193,255,.7)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
                    Cas d'étude · 01
                  </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 12 }}>
                {[
                  ...
                  <div key={x.l} style={{ textAlign: 'right' }}>
                    <div className="mono" style={{ fontSize: 10.5, color: 'rgba(169,193,255,.6)', letterSpacing: '0.16em', textTransform: 'uppercase' }}>{x.l}</div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div className="mono" style={{ fontSize: 11, color: 'rgba(169,193,255,.75)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
                Ce qui a été livré
              </div>
              <ul style={{
                ...
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, fontSize: 13.5, color: 'rgba(255,255,255,.85)', lineHeight: 1.5 }}>
                    <span style={{ flexShrink: 0, width: 14, height: 14, borderRadius: '50%', background: 'rgba(59,130,246,.25)', marginTop: 3, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                      <svg width="8" height="8" viewBox="0 0 8 8" fill="none"><path d="M1.5 4.5 L3 6 L6.5 2" stroke="#A9C1FF" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    </span>
                    {x}
                  </li>
                ))}
              ...
              {[
                ...
                <div key={x.l}>
                  <div style={{
                    ...
                    lineHeight: 1,
                    background: 'linear-gradient(180deg, #fff 0%, #A9C1FF 100%)',
          ...
          <div style={{
            ...
            {[
              ...
              <div key={x.label} style={{ position: 'relative' }}>
                <div className="mono" style={{
                  fontSize: 11,
                  color: i === 0 ? 'rgba(255,255,255,.5)' : '#A9C1FF',
          ...
          <div style={{
            ...
            {[
              ...
              <div key={g.title} style={{
                ...
                <div className="mono" style={{ fontSize: 10.5, color: 'rgba(169,193,255,.7)', letterSpacing: '0.18em', textTransform: 'uppercase' }}>
                  {g.title}
                </div>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginTop: 14 }}>
                  {g.items.map((it) => (
                    <span key={it} style={{
                      ...
                      <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#A9C1FF', boxShadow: '0 0 6px rgba(169,193,255,.6)' }}></span>
                      {it}
                    </span>
                  ))}
                </div>
          ...
          <div style={{
            ...
            <a href="https://www.tradeauto.ch" target="_blank" rel="noopener noreferrer" style={{
              ...
              padding: '14px 22px',
              borderRadius: 999,
              background: 'linear-gradient(180deg, #9B6FFB, #2F5BEA)',
              color: '#fff',
              fontSize: 15, fontWeight: 500,
              boxShadow: '0 10px 30px -8px rgba(47,91,234,.55), inset 0 1px 0 rgba(255,255,255,.12)',
              transition: 'transform .2s, box-shadow .2s',
              textDecoration: 'none',
            }}
            onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-1px)'; e.currentTarget.style.boxShadow = '0 16px 40px -8px rgba(47,91,234,.7), inset 0 1px 0 rgba(255,255,255,.12)'; }}
            onMouseLeave={(e) => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = '0 10px 30px -8px rgba(47,91,234,.55), inset 0 1px 0 rgba(255,255,255,.12)'; }}
            >
              Ouvrir tradeauto.ch
    ...
    <section style={{ padding: pad, background: 'var(--bg)' }}>
      <div style={{ maxWidth: 1280, margin: '0 auto' }}>
        <div style={{
          ...
          borderRadius: isMobile ? 20 : 28,
          overflow: 'hidden',
          background: 'linear-gradient(180deg, #0B0918 0%, #130726 50%, #080410 100%)',
          border: '1px solid rgba(245,158,11,.2)',
          boxShadow: '0 40px 120px -30px rgba(245,158,11,.22), 0 20px 60px -20px rgba(0,0,0,.5)',
        }}>
          {/* ambient glow — gold + violet */}
          <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 15% -10%, rgba(245,158,11,.22), transparent 55%), radial-gradient(ellipse at 85% 110%, rgba(59,130,246,.2), transparent 55%)', pointerEvents: 'none' }}></div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, position: 'relative' }}>
                {[
                  { role: 'FREELANCE', desc: 'Onboarding · candidature · calendrier', color: '#7DA2FF', icon: 'M7 3a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-6 11a6 6 0 1 1 12 0v1H1v-1Z' },
              ...
              <div style={{
                padding: '14px 12px',
                borderRadius: 12,
                background: 'linear-gradient(180deg, rgba(245,158,11,.1), rgba(59,130,246,.08))',
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 5, position: 'relative' }}>
                {[
                  ...
                  <span key={s.n} style={{
                    ...
                    background: s.highlight ? 'rgba(59,130,246,.12)' : 'rgba(255,255,255,.05)',
                    border: s.highlight ? '1px solid rgba(59,130,246,.4)' : '1px solid rgba(255,255,255,.1)',
          ...
          <div style={{
            ...
            <div style={{
              borderRadius: 16,
              overflow: 'hidden',
              background: 'linear-gradient(135deg, rgba(244,114,182,.08), rgba(59,130,246,.06) 50%, rgba(245,158,11,.08))',
          ...
          <div style={{
            ...
            {[
              ...
              <div key={x.label} style={{ position: 'relative' }}>
                <div className="mono" style={{
                  fontSize: 11,
                  color: i === 0 ? 'rgba(255,255,255,.5)' : (i === 2 ? '#FCD34D' : '#A9C1FF'),
                  letterSpacing: '0.18em',
                  textTransform: 'uppercase',
                  fontWeight: 500,
                }}>
          ...
          {OTHER_CASES.map((c, i) => (
            <div key={i} className="k-case">
              <div style={{
                ...
                background: c.tone === 'violet' ? 'linear-gradient(150deg, #F2F6FF, #E3ECFF)' : c.tone === 'ink' ? '#0A0A0A' : 'linear-gradient(150deg, #FFFFFF, #F2F6FF)',
                ...
                {c.tone === 'ink' && (
                  <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 80% 0%, rgba(59,130,246,.35), transparent 60%)' }}></div>
                )}
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative' }}>
                  ...
                  <span className="mono" style={{
                    ...
                    background: c.tone === 'ink' ? 'rgba(169,193,255,.15)' : 'rgba(59,130,246,.1)',
                    color: c.tone === 'ink' ? '#A9C1FF' : 'var(--violet-deep)',
                    border: c.tone === 'ink' ? '1px solid rgba(169,193,255,.25)' : '1px solid rgba(59,130,246,.15)',
                ...
                <div className="k-metric-num" style={{
                  ...
                  background: c.tone === 'ink'
                    ? 'linear-gradient(180deg, #fff, #A9C1FF)'
...
function SelectionCriteria({ isMobile }) {
  ...
  return (
    <section style={{ padding: pad, background: 'linear-gradient(180deg, #F2F6FF 0%, #FAFAFA 60%, #F2F6FF 100%)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {[
              ...
              <div key={i} style={{
                ...
                <span style={{ flexShrink: 0, width: 22, height: 22, borderRadius: 6, background: 'linear-gradient(135deg, #A9C1FF, #3B82F6)', marginTop: 2, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    <section className="band ia" id="isolation-aquitaine">
      <div className="wrap">
        <div className="ia-top">
          <div>
            <span className="pill"><span className="pill-dot"><i /></span>Cas d’étude · Nouveau</span>
...
function RealisationsTestimonials() {
  return (
    <section className="band real-quotes">
      <div className="wrap">
        <div className="sec-head">
          <span className="pill"><span className="pill-dot"><i /></span>Ils en parlent</span>
          <h2 className="h2">Leurs mots, <span className="serif grad-text">pas les nôtres.</span></h2>
        </div>
        <div className="real-quotes-grid">
          {REALIS_TESTIMONIALS.map((t) => (
            <figure key={t.c} className="real-quote">
              <span className="cases2-qmark" aria-hidden="true">“</span>
              <blockquote>« {t.q} »</blockquote>
              <figcaption>
                <img src={t.logo} alt="" width="40" height="40" />
                <span><b>{t.n} · {t.p}</b><small>{t.c}</small></span>
              </figcaption>
            </figure>
          ))}
        </div>
    ...
    <MotionConfig reducedMotion="user">
      <div className="v2 real">
        ...
        <main id="contenu">
          <RealisationsHero />
          <FeaturedIsolation />
          {/* Sections de la V1, recolorées ; les classes .kairn gardent leur mise en forme d'origine */}
          <div className="kairn kairn-v2">
          ...
          <section id="contact" style={{ paddingBottom: 'var(--band-sm)' }}>
            <div className="final">
              ...
              <div className="final-inner">
                <span className="pill"><span className="pill-dot"><i /></span>Le prochain projet</span>
                <h2 className="h2">Et si le prochain, <span className="serif">c’était le vôtre ?</span></h2>
                <p className="final-lead">30 minutes pour regarder votre offre et vos chiffres, et vous dire franchement ce qu’on ferait.</p>
